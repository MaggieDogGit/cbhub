  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ...
        ('Albania','AL','ALB',8,'Republic of Albania','Tirana','EEA'),
        ...
        ('Azerbaijan','AZ','AZE',31,'Republic of Azerbaijan','Baku','Asia-Pacific'),
        ...
        ('Belarus','BY','BLR',112,'Republic of Belarus','Minsk','EEA'),
        ...
        ('Bosnia and Herzegovina','BA','BIH',70,'Bosnia and Herzegovina','Sarajevo','EEA'),
        ...
        ('Georgia','GE','GEO',268,'Georgia','Tbilisi','Asia-Pacific'),
        ...
        ('Kosovo','XK','XKX',NULL,'Republic of Kosovo','Pristina','EEA'),
        ...
        ('Moldova','MD','MDA',498,'Republic of Moldova','Chisinau','EEA'),
        ...
        ('North Macedonia','MK','MKD',807,'Republic of North Macedonia','Skopje','EEA'),
        ...
        ('Russia','RU','RUS',643,'Russian Federation','Moscow','Asia-Pacific'),
        ...
        ('San Marino','SM','SMR',674,'Republic of San Marino','San Marino','SEPA'),
        ...
        ('Serbia','RS','SRB',688,'Republic of Serbia','Belgrade','EEA'),
        ...
        ('Ukraine','UA','UKR',804,'Ukraine','Kyiv','EEA'),
        ...
        ('Vatican City','VA','VAT',336,'Vatican City State','Vatican City','SEPA'),
