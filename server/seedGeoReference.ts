  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ...
        ('Albania','AL','ALB',8,'Republic of Albania','Tirana','CEE'),
        ...
        ('Angola','AO','AGO',24,'Republic of Angola','Luanda','Sub-Saharan Africa'),
        ...
        ('Bosnia and Herzegovina','BA','BIH',70,'Bosnia and Herzegovina','Sarajevo','CEE'),
        ...
        ('Cameroon','CM','CMR',120,'Republic of Cameroon','Yaounde','Sub-Saharan Africa'),
        ('Canada','CA','CAN',124,'Canada','Ottawa','Americas'),
        ('Central African Republic','CF','CAF',140,'Central African Republic','Bangui','Sub-Saharan Africa'),
        ('Chad','TD','TCD',148,'Republic of Chad','N''Djamena','Sub-Saharan Africa'),
        ...
        ('Comoros','KM','COM',174,'Union of the Comoros','Moroni','Sub-Saharan Africa'),
        ...
        ('Guinea-Bissau','GW','GNB',624,'Republic of Guinea-Bissau','Bissau','Sub-Saharan Africa'),
        ...
        ('Kenya','KE','KEN',404,'Republic of Kenya','Nairobi','Sub-Saharan Africa'),
        ('Kiribati','KI','KIR',296,'Republic of Kiribati','Tarawa','Asia-Pacific'),
        ('Kosovo','XK','XKX',NULL,'Republic of Kosovo','Pristina','CEE'),
        ...
        ('Moldova','MD','MDA',498,'Republic of Moldova','Chisinau','CEE'),
        ('Monaco','MC','MCO',492,'Principality of Monaco','Monaco','Europe'),
        ('Mongolia','MN','MNG',496,'Mongolia','Ulaanbaatar','Asia-Pacific'),
        ('Montenegro','ME','MNE',499,'Montenegro','Podgorica','CEE'),
        ('Morocco','MA','MAR',504,'Kingdom of Morocco','Rabat','MENA'),
        ('Mozambique','MZ','MOZ',508,'Republic of Mozambique','Maputo','Sub-Saharan Africa'),
        ...
        ('Sao Tome and Principe','ST','STP',678,'Democratic Republic of Sao Tome and Principe','Sao Tome','Sub-Saharan Africa'),
        ('Saudi Arabia','SA','SAU',682,'Kingdom of Saudi Arabia','Riyadh','MENA'),
        ('Senegal','SN','SEN',686,'Republic of Senegal','Dakar','Sub-Saharan Africa'),
        ('Serbia','RS','SRB',688,'Republic of Serbia','Belgrade','CEE'),
        ...
        ('Tanzania','TZ','TZA',834,'United Republic of Tanzania','Dodoma','Sub-Saharan Africa'),
        ...
        ('Togo','TG','TGO',768,'Togolese Republic','Lome','Sub-Saharan Africa'),
    ...
    console.log(`[GeoSeed] Bootstrap complete: ${r.countries} countries, ${r.currencies} currencies, ${r.links} links`);
  } catch (err) {
